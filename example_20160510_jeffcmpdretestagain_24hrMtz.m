...
filename = fullfile('F:\CellProfiler Output\2016.05.10 Known Cmpd Redo','2016.05.10 Plate 1Image.csv');
...
platemap.negctrl_lo = createWellGroups('H', 'H', 1, 12);
platemap.threeMA_lo = createWellGroups('B', 'B', 1, 12);
platemap.Rufin_lo = createWellGroups('C', 'C', 1, 12);
platemap.Aemp_lo = createWellGroups('D', 'D', 1, 12);
platemap.UCF101_lo = createWellGroups('E', 'E', 1, 12);
platemap.BAX_lo = createWellGroups('F', 'F', 1, 12);
platemap.Quercetin_lo = createWellGroups('G', 'G', 1, 12);
...
%% Plate 2
filename = fullfile('F:\CellProfiler Output\2016.05.10 Known Cmpd Redo','2016.05.10 Plate 2Image.csv');
...
platemap.negctrl_hi = createWellGroups('H', 'H', 1, 12);
platemap.threeMA_hi = createWellGroups('B', 'B', 1, 12);
platemap.Rufin_hi = createWellGroups('C', 'C', 1, 12);
platemap.Aemp_hi = createWellGroups('D', 'D', 1, 12);
% platemap.UCF101_hi = createWellGroups('E', 'E', 1, 12);
platemap.BAX_hi = createWellGroups('F', 'F', 1, 12);
platemap.Quercetin_hi = createWellGroups('G', 'G', 1, 12);
