...
filename = fullfile('F:\CellProfiler Output\2016.06.03 dmso plate retest','2016.06.03 dmso plate retestImage.csv');
...
platemap.Mtz = createWellGroups('A', 'H', 1, 4);
platemap.DMSO = createWellGroups('A', 'H', 5, 8);
platemap.Ctrl = createWellGroups('A', 'H', 9, 12);
...
% platemap.onetwentyNAC = createWellGroups('B', 'B', 1, 12);
clear platemap
platemap.posctrlOld = createWellGroups('A', 'H', 1, 1);
platemap.negctrlOld = createWellGroups('A', 'H', 12, 12);
