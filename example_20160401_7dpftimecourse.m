...
filename = fullfile('F:\CellProfiler Output\2016.04.01_7dpftimecourse','2016.04.01_7dpftimecourseImage.csv');
...
platemap.pos45 = createWellGroups('A', 'A', 1, 6);
platemap.pos9 = createWellGroups('A', 'A', 7, 12);
platemap.neg45 = createWellGroups('B', 'B', 1, 6);
platemap.neg9 = createWellGroups('B', 'B', 7, 12);
platemap.eightHr45 = createWellGroups('C', 'C', 1, 6);
platemap.eightHr9 = createWellGroups('C', 'C', 7, 12);
platemap.twelveHr45 = createWellGroups('D', 'D', 1, 6);
platemap.twelveHr9 = createWellGroups('D', 'D', 7, 12);
platemap.sixteenHr45 = createWellGroups('E', 'E', 1, 6);
platemap.sixteenHr9 = createWellGroups('E', 'E', 7, 12);
platemap.twentyHr45 = createWellGroups('F', 'F', 1, 6);
platemap.twentyHr9 = createWellGroups('F', 'F', 7, 12);
platemap.twentyfourHr45 = createWellGroups('G', 'G', 1, 6);
platemap.twentyfourHr9 = createWellGroups('G', 'G', 7, 12);
