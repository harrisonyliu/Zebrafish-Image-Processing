...
res.crop1 = [cropy1 cropy2 cropx1 cropx2];
...
smallcropy1 = cropped_center - 450; smallcropy2 = cropped_center + 450;
smallcropx1 = cropped_center - 250; smallcropx2 = cropped_center + 250;
res.crop2 = [smallcropy1 smallcropy2 smallcropx1 smallcropx2];
try
...
pupil_distance = sqrt((x2 - x1)^2 + (y2 - y1)^2); neuron_distance = 75;
...
res.eye1 = [x1, y1];res.eye2 = [x2, y2];res.neuron = [neuron_x, neuron_y];res.midpt = [midpt_x, midpt_y];
