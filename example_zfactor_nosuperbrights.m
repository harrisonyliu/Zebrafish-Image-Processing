...
filename = fullfile('F:\CellProfiler Output\20151207NACdoseresponse','20160105Zfactor5dpf_nosuperbrightsImage.csv');
...
plate_struct = separateReplicatePlates(filename,'Count_Neurons',...
    'ghettoconv','TotalIntensity_inner_brain_Neurons','position_measure',...
