...
filename = fullfile('F:\CellProfiler Output\2016.08.10 Mtz Dose Response','2016.08.10 Mtz Dose ResponseImage.csv');
...
platemap.mM18 = createWellGroups('A', 'A', 1, 12);
platemap.mM9 = createWellGroups('B', 'B', 1, 12);
platemap.mM45 = createWellGroups('C', 'C', 1, 12);
platemap.mM225 = createWellGroups('D', 'D', 1, 12);
platemap.mM1125 = createWellGroups('E', 'E', 1, 12);
platemap.mM562 = createWellGroups('F', 'F', 1, 12);
platemap.mM281 = createWellGroups('G', 'G', 1, 12);
platemap.DMSO = createWellGroups('H', 'H', 1, 12);
