close all
clear all
filename = fullfile('C:\Users\harri_000\20160116_combinatorics','20160116_combinatorics_plate1Image.csv');
...
platemap.twofour = createWellGroups('A', 'A', 1, 12);
platemap.twofive = createWellGroups('B', 'B', 1, 12);
platemap.twoseven = createWellGroups('C', 'C', 1, 12);
platemap.twoeight = createWellGroups('D', 'D', 1, 12);
platemap.fourfive = createWellGroups('E', 'E', 1, 12);
platemap.fourseven = createWellGroups('F', 'F', 1, 12);
platemap.foureight = createWellGroups('G', 'G', 1, 12);
platemap.fiveseven = createWellGroups('H', 'H', 1, 12);
...
%% 
filename = fullfile('C:\Users\harri_000\20160116_combinatorics','20160116_combinatorics_plate2Image.csv');
...
%Next tell the computer which wells should be grouped together
clear platemap
platemap.fiveeight = createWellGroups('A', 'A', 1, 12);
platemap.seveneight = createWellGroups('B', 'B', 1, 12);
platemap.two = createWellGroups('C', 'C', 1, 12);
platemap.four = createWellGroups('D', 'D', 1, 12);
platemap.five = createWellGroups('E', 'E', 1, 12);
platemap.seven = createWellGroups('F', 'F', 1, 12);
platemap.posctrl = createWellGroups('G', 'G', 1, 12);
...
%Next tell the computer which wells should be grouped together
clear platemap
platemap.eight = createWellGroups('A', 'A', 1, 12);
