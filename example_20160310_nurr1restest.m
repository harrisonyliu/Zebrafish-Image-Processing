...
filename = fullfile('F:\CellProfiler Output\20160310_nurr1retest','20160310_nurr1retest_plate1Image.csv');
...
platemap.DHI = createWellGroups('A', 'H', 1, 4);
platemap.DHIAmo = createWellGroups('A', 'H', 5, 8);
...
filename = fullfile('F:\CellProfiler Output\20160310_nurr1retest','20160310_nurr1retest_plate2Image.csv');
...
% platemap.onetwentyNAC = createWellGroups('B', 'B', 1, 12);
clear platemap
platemap.posctrl = createWellGroups('A', 'H', 1, 4);
platemap.negctrl = createWellGroups('A', 'H', 5, 8);
platemap.MtzDHI = createWellGroups('A', 'H', 9, 12);
