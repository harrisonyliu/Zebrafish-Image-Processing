...
filename = fullfile('F:\CellProfiler Output\2016.09.26 MPP+ drugs','2016.09.26 MPP+ drugsImage.csv');
...
platemap.P7C3_1uM = createWellGroups('A', 'H', 2, 2);
platemap.P7C3_5uM = createWellGroups('A', 'H', 3, 3);
platemap.P7C3_10uM = createWellGroups('A', 'H', 4, 4);
platemap.P7C3_50uM = createWellGroups('A', 'H', 5, 5);
platemap.P7C3_250uM = createWellGroups('A', 'H', 6, 6);
platemap.MMF_1uM = createWellGroups('A', 'H', 7, 7);
platemap.MMF_5uM = createWellGroups('A', 'H', 8, 8);
platemap.MMF_10uM = createWellGroups('A', 'H', 9, 9);
platemap.MMF_50uM = createWellGroups('A', 'H', 10, 10);
platemap.MMF_250uM = createWellGroups('A', 'H', 11, 11);
