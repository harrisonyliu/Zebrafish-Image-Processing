...
filename = fullfile('F:\CellProfiler Output\20160322_newKnownCmpd','20160322_newKnownCmpdImage.csv');
...
platemap.EGCG = createWellGroups('A', 'H', 2, 3);
platemap.Quercetin = createWellGroups('A', 'H', 4, 5);
platemap.BAX = createWellGroups('A', 'H', 6, 7);
platemap.Ampelopsin = createWellGroups('A', 'H', 8, 9);
platemap.Rutin = createWellGroups('A', 'H', 10, 11);
