...
filename = fullfile('F:\CellProfiler Output\2016.04.04_nurr1DoseResponse','2016.04.04_nurr1DoseResponse_1dpfImage.csv');
...
platemap.DMSO1dpf = createWellGroups('A', 'B', 1, 12);
platemap.DHI200uM1dpf = createWellGroups('C', 'C', 1, 12);
platemap.DHI100uM1dpf = createWellGroups('D', 'D', 1, 12);
platemap.DHI50uM1dpf = createWellGroups('E', 'E', 1, 12);
platemap.DHI25uM1dpf = createWellGroups('F', 'F', 1, 12);
platemap.DHI10uM1dpf = createWellGroups('G', 'G', 1, 12);
platemap.DHI1uM1dpf = createWellGroups('H', 'H', 1, 12);
...
filename = fullfile('F:\CellProfiler Output\2016.04.04_nurr1DoseResponse','2016.04.04_nurr1DoseResponse_3dpfImage.csv');
...
clear platemap;
platemap.DMSO3dpf = createWellGroups('A', 'A', 1, 12);
platemap.Mtz3dpf = createWellGroups('B', 'B', 1, 12);
platemap.DHI200uM3dpf = createWellGroups('C', 'C', 1, 12);
platemap.DHI100uM3dpf = createWellGroups('D', 'D', 1, 12);
platemap.DHI50uM3dpf = createWellGroups('E', 'E', 1, 12);
platemap.DHI25uM3dpf = createWellGroups('F', 'F', 1, 12);
platemap.DHI10uM3dpf = createWellGroups('G', 'G', 1, 12);
platemap.DHI1uM3dpf = createWellGroups('H', 'H', 1, 12);
