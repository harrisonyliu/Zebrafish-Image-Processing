filename = fullfile('C:\Users\harri_000\20150924Nurr1Test','20150924Nurr1TestImage.csv');
...
platemap.neg_9 = createWellGroups('A', 'H', 7, 7);
platemap.neg_4 = createWellGroups('A', 'H', 12, 12);
platemap.DHI_9 = createWellGroups('A', 'H', 4, 4);
platemap.San_9 = createWellGroups('A', 'H', 3, 3);
platemap.Amo_9 = createWellGroups('A', 'H', 2, 2);
platemap.War_9 = createWellGroups('A', 'H', 5, 5);
platemap.Cou_9 = createWellGroups('A', 'H', 6, 6);
platemap.DHI_4 = createWellGroups('A', 'H', 10, 10);
platemap.San_4 = createWellGroups('A', 'H', 9, 9);
platemap.Amo_4 = createWellGroups('A', 'H', 8, 8);
platemap.War_4 = createWellGroups('A', 'H', 11, 11);
