...
filename = fullfile('F:\CellProfiler Output\20160223_acuteexposure','20160223_acuteexposure_plate1Image.csv');
...
platemap.posctrl = createWellGroups('A', 'B', 1, 12);
platemap.fourfivefour = createWellGroups('C', 'D', 1, 12);
platemap.ninefour = createWellGroups('E', 'F', 1, 12);
platemap.fourfiveeight = createWellGroups('G', 'H', 1, 12);
...
filename = fullfile('F:\CellProfiler Output\20160223_acuteexposure','20160223_acuteexposure_plate2Image.csv');
...
% platemap.onetwentyNAC = createWellGroups('B', 'B', 1, 12);
clear platemap;
platemap.nineeight = createWellGroups('A', 'B', 1, 12);
platemap.fourfivetwelve = createWellGroups('C', 'D', 1, 12);
platemap.ninetwelve = createWellGroups('E', 'F', 1, 12);
platemap.fourfivesixteen = createWellGroups('G', 'H', 1, 12);
...
filename = fullfile('F:\CellProfiler Output\20160223_acuteexposure','20160223_acuteexposure_plate3Image.csv');
...
% platemap.onetwentyNAC = createWellGroups('B', 'B', 1, 12);
clear platemap;
platemap.ninesixteen = createWellGroups('A', 'B', 1, 12);
platemap.fourfivetwentyfour = createWellGroups('C', 'C', 1, 12);
platemap.ninetwentyfour = createWellGroups('D', 'D', 1, 12);
platemap.fourfivefortyeight = createWellGroups('E', 'E', 1, 12);
platemap.ninefortyeight = createWellGroups('F', 'F', 1, 12);
