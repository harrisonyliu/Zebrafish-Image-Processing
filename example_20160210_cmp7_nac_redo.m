...
filename = fullfile('C:\Users\harri_000\20160208_nac_cmp7_retry','20160208_nac_cmp7_plateImage.csv');
...
platemap.posctrl = createWellGroups('E', 'E', 1, 12);
platemap.negctrl = createWellGroups('F', 'F', 1, 12);
platemap.tenCmpdSeven = createWellGroups('C', 'C', 1, 12);
% platemap.fortyCmpdSeven = createWellGroups('D', 'D', 1, 12);
