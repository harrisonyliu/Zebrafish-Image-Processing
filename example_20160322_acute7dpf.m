...
filename = fullfile('F:\CellProfiler Output\20160322_7dpfAcuteTimeExpt','20160322_7dpfAcuteTimeExpt_plate1Image.csv');
...
platemap.fourHr = createWellGroups('A', 'B', 1, 12);
platemap.eightHr = createWellGroups('C', 'D', 1, 12);
platemap.tenHr = createWellGroups('E', 'F', 1, 12);
platemap.twelveHr = createWellGroups('G', 'H', 1, 12);
...
filename = fullfile('F:\CellProfiler Output\20160322_7dpfAcuteTimeExpt','20160322_7dpfAcuteTimeExpt_plate2Image.csv');
...
clear platemap;
platemap.Dicou10uM = createWellGroups('A', 'A', 1, 6);
platemap.posctrl = createWellGroups('B', 'C', 1, 12);
...
filename = fullfile('F:\CellProfiler Output\20160323_6dpfAcute','20160323_6dpfAcuteImage.csv');
...
% platemap.onetwentyNAC = createWellGroups('B', 'B', 1, 12);
clear platemap;
platemap.fourHr6dpf = createWellGroups('A', 'B', 1, 12);
platemap.eightHr6dpf = createWellGroups('C', 'D', 1, 12);
platemap.tenHr6dpf = createWellGroups('E', 'F', 1, 12);
platemap.twelveHr6dpf = createWellGroups('G', 'H', 1, 12);
